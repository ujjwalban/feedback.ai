    ...
    <div className="flex min-h-screen flex-col bg-background font-sans text-foreground selection:bg-primary selection:text-primary-foreground overflow-x-hidden">
      ...
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container mx-auto flex h-20 items-center justify-between px-6">
          <Link href="/">
            <AnimatedBrand iconSize={32} textSize="text-2xl" />
          </Link>
          ...
          <div className="flex items-center gap-6">
            ...
            <Link href="/signup">
              <Button className="font-black italic uppercase tracking-widest rounded-2xl h-11 px-8 shadow-[0_10px_20px_-5px_rgba(var(--primary-rgb),0.3)] hover:shadow-[0_15px_25px_-5px_rgba(var(--primary-rgb),0.4)] transition-all active:scale-95">
                Join Now
              </Button>
            </Link>
          </div>
      ...
      <main className="flex-1">
        ...
        <section id="features" className="w-full py-32 bg-muted/20 border-y border-border/50 relative overflow-hidden">
          ...
          <div className="container mx-auto px-6">
            <div className="flex flex-col items-center text-center space-y-6 mb-24">
              ...
              <h2 className="text-4xl md:text-6xl font-black tracking-tighter italic">Built for <span className="text-primary underline decoration-primary/20">Hyper-Growth.</span></h2>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
              {[
                ...
                <motion.div
                  ...
                  className="group relative flex flex-col p-10 bg-card/50 backdrop-blur-sm rounded-[2.5rem] border border-border/50 shadow-xl hover:shadow-2xl hover:border-primary/20 transition-all duration-500"
                >
        ...
        <section id="testimonials" className="py-32 container mx-auto px-6 overflow-hidden">
          <div className="flex flex-col lg:flex-row items-center gap-20">
            ...
            <div className="flex-1 relative">
              ...
              <Card className="rounded-[2.5rem] border-none shadow-2xl p-10 rotate-3 hover:rotate-0 transition-transform duration-700 bg-background/80 backdrop-blur-xl">
        ...
        <section id="pricing" className="w-full py-32 bg-primary text-primary-foreground relative overflow-hidden">
          ...
          <div className="container mx-auto px-6 relative z-10">
            ...
            <div className="grid md:grid-cols-2 gap-10 max-w-5xl mx-auto">
              <div className="flex flex-col p-12 bg-white/10 backdrop-blur-md rounded-[3rem] border border-white/20 shadow-2xl">
              ...
              <div className="flex flex-col p-12 bg-white rounded-[3rem] text-primary shadow-2xl relative">
        ...
        <section className="w-full py-48 container mx-auto px-6 text-center space-y-12">
          <h2 className="text-5xl md:text-8xl font-black italic tracking-tighter leading-tight max-w-5xl mx-auto">
      ...
      <footer className="w-full py-20 border-t bg-muted/20">
        <div className="container mx-auto px-6 flex flex-col items-center gap-12">
          <Link href="/">
            <AnimatedBrand iconSize={40} textSize="text-3xl" />
          </Link>
